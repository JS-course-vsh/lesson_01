...
//============================================================================================
//========= задание 2, вариант 2 - проверки перенесены внутрь фнкции  ========================
//============================================================================================
...
if(numb1 > str1.length) {
  simb1 = prompt("Введите символ дополнения");
  side1 = prompt("Для добавления символов слева - введите \"0\"; справа - \"1\"");
}
...
function padString2(p_str, p_numb, p_simb = '', p_side = '1') {
  ...
  console.log(p_str, typeof p_str, p_numb, isNaN(p_numb), p_simb, typeof p_simb, p_side, typeof p_side);
  if(!p_str) {
    flg = false;
